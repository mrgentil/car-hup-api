...
<head>
    ...
    <meta name="Bedi Tshitsho" content="Car Hub">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta content="Notre priorité est de rendre votre expérience de location de voitures en
    ligne agréable, sécurisée et sans tracas. Avec notre application conviviale, vous pouvez économiser du temps et de l'argent tout en
     bénéficiant d'une flexibilité maximale dans la gestion de vos réservations de voitures"
          name="description" />
    <title>@section('title')Car Hub | DASHBOARD  @show</title>
    <!-- Favicon -->
    <link rel="icon" href="{{asset('images/model-icon.png')}}">
